...
5. Signing & Capabilities で Automatic Signing を有効化し、Team を選択（EAS credentials と同じ Apple Team）

### 3) Deep Link

- アプリ側スキーム: `timetosell://`（`mobile/app.json` の `scheme`）
- Widget のリンク先: `timetosell://dashboard`
